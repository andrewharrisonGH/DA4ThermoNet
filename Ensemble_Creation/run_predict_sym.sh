...
# The job command(s):
for i in `seq 1 10`; do python predict_new.py -xf ssym_tensors_fwd.npy -xr ssym_tensors_rev.npy -m DA0rotTN_member_${i}.h5 -o Ssym2_DA0rotTN_predictions_${i}.txt; done
